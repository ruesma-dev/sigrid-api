...
Resumen: **4 features**, 3 abiertas, 1 terminadas.
...
| F-003 | El guardia de escritura debe validar tambien las bases nombradas dentro del SQL | 3 | en curso | critico | `feature/F-003-guardia-bases-cruzadas` |
...
estado **en curso** · prioridad 3 · rigor `critico` · SDD sí · rama `feature/F-003-guardia-bases-cruzadas`
