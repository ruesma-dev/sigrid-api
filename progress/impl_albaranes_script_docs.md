...
- El repositorio está marcado archivado (`cab78e2` «ARCHIVADO: migrado al monorepo albaranes; no trabajar aqui») y hay copia viva sin corregir en `albaranes/services/albaranes-persistencia/scripts/`. Se corrigió donde se pidió; propagar al monorepo queda pendiente.
